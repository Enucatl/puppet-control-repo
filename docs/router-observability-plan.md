...
- **Suricata EVE**
  ...
  - Use low-cardinality labels only: `job`, `host`, `event_type`, and country codes. Keep IPs, ports, signatures, hostnames, ASN, and city out of labels, but append prefixed city-level GeoIP details to the stored JSON log line.
